...
let TechnicalFormSubServiceComponent = class TechnicalFormSubServiceComponent {
    ...
    ngOnInit() {
        this.categories = RequestedService.getSubService(this.service.id);
...
__decorate([
    Input()
], TechnicalFormSubServiceComponent.prototype, "service", void 0);
__decorate([
    Output()
], TechnicalFormSubServiceComponent.prototype, "canProceedEvent", void 0);
__decorate([
    Input()
], TechnicalFormSubServiceComponent.prototype, "category", void 0);
__decorate([
    Output()
], TechnicalFormSubServiceComponent.prototype, "categoryChange", void 0);
TechnicalFormSubServiceComponent = __decorate([
    Component({
...
export { TechnicalFormSubServiceComponent };
